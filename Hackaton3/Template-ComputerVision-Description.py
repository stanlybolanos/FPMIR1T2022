...
for Imagen in ListadoImagenes:
    ...
    ContenidoImagen=cv_client.describe_image_in_stream() #investigue que parametros se necesitan para llamar a detect_objects_in_stream
    #Iteramos sobre cotenido
    for Descripcion in ContenidoImagen.captions: #Recoremos objetos encontrado
        #Aqui mostramos la descripcion de la imagen
